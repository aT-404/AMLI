...
export const load = (async ({ fetch, params, cookies, locals }) => {
	...
	const folderId = typeof compliance_assessment.folder === 'object' && compliance_assessment.folder !== null
	...
	const [
		...
		safeJson(fetch(objectEndpoint), {}),
		safeJson(fetch(`${endpoint}tree/`), {}),
		safeJson(fetch(`${BASE_API_URL}/${URLModel}/${params.id}/donut_data/`), {}),
		safeJson(fetch(`${BASE_API_URL}/${URLModel}/${params.id}/global_score/`), {}),
		safeJson(fetch(`${BASE_API_URL}/${URLModel}/${params.id}/threats_metrics/`), {}),
		safeJson(fetch(`${BASE_API_URL}/${URLModel}/${params.id}/frameworks/`), []),
