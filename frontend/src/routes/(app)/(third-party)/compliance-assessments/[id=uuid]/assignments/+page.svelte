...
<div class="flex flex-col space-y-4">
	...
	<div class="flex items-center justify-between">
		...
		<Anchor
			...
			class="px-4 py-2 rounded-lg bg-surface-100-900 border border-surface-200-800 text-surface-900-100 hover:bg-surface-200-800 text-xs font-semibold flex items-center gap-2 transition-all shadow-xs"
		>
			<i class="fa-solid fa-list-check text-purple-500"></i>
			<span>Global Control Assignments</span>
		</Anchor>
	</div>
