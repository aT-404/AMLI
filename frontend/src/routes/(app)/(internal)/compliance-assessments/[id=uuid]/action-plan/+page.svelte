...
<div class="bg-surface-50-950 p-2 shadow-sm rounded-lg space-x-2 flex flex-row justify-center mb-2">
	...
	{#if data.compliance_assessment.framework}
		<p>/</p>
		<p class="font-semibold text-lg">
			{m.framework()}:
			<a
	...
	<div class="flex justify-between items-center w-full">
		...
		<div class="flex gap-2 ml-auto items-center">
			<Anchor
				...
				class="btn bg-cyan-600 hover:bg-cyan-500 text-white font-semibold h-fit flex items-center gap-2"
				title="Sync controls from non-compliant requirements"
			>
