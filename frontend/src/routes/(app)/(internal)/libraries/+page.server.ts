...
export const load = (async ({ fetch }) => {
	...
	const storedLibraries = storedLibrariesResponse.ok ? await storedLibrariesResponse.json() : { results: [] };
	const results = storedLibraries.results || [];
