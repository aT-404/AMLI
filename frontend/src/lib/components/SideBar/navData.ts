export const navData = {
	items: [
...

		{
			...
			items: [
				{
					name: 'intermediaryAssignments',
					fa_icon: 'fa-solid fa-user-check',
					href: '/intermediary-compliance/assignments'
				},
				{
					name: 'reportRepository',
					fa_icon: 'fa-solid fa-folder-tree',
					href: '/intermediary-compliance/repository'
				},
				{
					name: 'reportGeneration',
					fa_icon: 'fa-solid fa-chart-pie',
					href: '/intermediary-compliance/reports'
				}
			]
		},
		{
