...
from .models import PersonalAccessToken, User, FeatureToggle
...
class FeatureToggleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = FeatureToggle
        fields = ["id", "key", "name", "parent_key", "enabled_for_web_admin", "enabled_for_admin", "enabled_for_user", "user_exceptions"]
